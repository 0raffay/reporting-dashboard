            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-heading-wrapper">
                        <h1 class="text-center page-heading mb-5">Edit equipment</h1>
                    </div>
                    <!-- PAGE HEADING -->
                    ...
                    <div class="form-main-layout pb-5">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-4 ">Edit Equipment Details</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" value="Lunar Innovations" readonly class="form-control">
                            ...
                            <div class="row m-0 pt-2">
                                    ...
                                    <div class="form-group box-form-group">
                                        <div class="form-group-wrapper row p-0 m-0 ">
                                            ...
                                            <div class="col-md-10 p-0">
                                                <input type="text" value="123123123" id="info_1" class="form-control">
                                            </div>
                                        </div>
                                        <label class="col-md-12 col-form-label" for="notes_1">Notes:</label>
                                        <div class="col-md-12">
                                            <textarea rows="5" id="notes_1" class="form-control">Here are some notes for the future</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6  pl-0 pr-0 pl-lg-2 ">
                                    <div class="form-group box-form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" id="notes_1" class="form-control" placeholder="">Here are some special notes for the future</textarea>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group btn-form-group row mb-0 pt-4">
                                <div class="col-md-7 m-auto">
                                    <button type="submit" class=" btn btn-primary btn-lg w-100 d-block">Update Equipment Details</button>
                                </div>
                            </div>
                            <!-- button -->
                        </form>
