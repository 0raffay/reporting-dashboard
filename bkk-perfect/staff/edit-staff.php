            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-heading-wrapper">
                        <h1 class="text-center page-heading mb-5">Edit Staff</h1>
                    </div>
                    <!-- PAGE HEADING -->
                    ...
                    <div class="form-main-layout pb-5">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-4 ">Edit Staff Details</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" value="John Smith Jr." class="form-control" id="staff_name">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staff_email" class="col-md-2 control-label"> Email Address</label>
                                <div class="col-md-10">
                                    <input type="email" value="john@arrite.com" class="form-control" id="staff_email">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staff_phone" class="col-md-2 control-label"> Mobile Number</label>
                                <div class="col-md-10">
                                    <input type="text" value="+61 233 1232" class="form-control" id="staff_phone">
                                </div>
                            </div>
                            ...
                            <div class="form-group btn-form-group row mb-0 pt-4">
                                <div class="col-md-7 m-auto">
                                    <button type="submit" class="btn btn-primary btn-lg w-100 d-block">Update Staff Details</button>
                                </div>
                            </div>
                            <!-- button -->
                        </form>
