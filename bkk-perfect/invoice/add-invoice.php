            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="page-heading-wrapper">
                        <h1 class="text-center page-heading mb-5">Add invoice</h1>
                    </div>
                    <!-- PAGE HEADING -->
                    ...
                    <div class="form-main-layout pb-5">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div>
                                    <h4 class="header-title mb-4 ">Add invoice Details</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                        ...
                        <form class="form-horizontal">
                            <!-- <div class="form-group row">
                                <label class="col-md-2 col-form-label" for="client_function">Select invoices Function</label>
                                <div class="col-md-10">
                                    <select id="client_function" class="form-control">
                                        <option value="invoices_edit">invoices Edit</option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                            ...
                            <div class="form-group form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input type="date" class="form-control" placeholder="MM/DD/YY" id="invoice_date">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="invoice_job_number">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="invoice_report_number" class="col-md-2 control-label">Report Number</label>
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="invoice_report_number">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" rows="5" id="invoice_completed_work"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="number" class="form-control" id="invoice_quote_number">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-2 col-form-label" for="invoice_quoted_work">Invoice Quoted Work</label>
                                <div class="col-md-10">
                                    <textarea class="form-control" rows="5" id="invoice_quoted_work"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group btn-form-group row mb-0 pt-4">
                                <div class="col-md-7 m-auto">
                                    <button type="submit" class="btn btn-primary btn-lg w-100 d-block">Add Invoice</button>
                                </div>
                            </div>
                            <!-- button -->
                        </form>
